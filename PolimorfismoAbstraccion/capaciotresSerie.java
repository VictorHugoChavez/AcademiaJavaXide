...
public class capaciotresSerie extends operacion {// realizamos herencia  de la clase operacion
	...
	public capaciotresSerie(int valor1, int valor2, int valor3, int valor4) {
