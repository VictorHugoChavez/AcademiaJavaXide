...
public class resistenciaSerie extends operacion {// realizamos herencia  de la clase operacion
	...
	public resistenciaSerie(int valor1, int valor2, int valor3, int valor4) {
	...
	public double calulaTotal() {/// este es el metodo de la clase padre, como se definio como 
		...
		System.out.println("Para calcular la resistencia total es sumar todos los valores");
