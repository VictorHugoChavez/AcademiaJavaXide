...
public class resistenciaParaleoSerie extends operacion{// realizamos herencia de la clase operacion
	...
	public resistenciaParaleoSerie(int valor1, int valor2, int valor3, int valor4) {
